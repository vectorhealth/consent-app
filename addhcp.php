        ...
        <div class="input-form add-hcp-form">
            ...
            <form class="form-signin w-50" method="post" action="addhcp.php">
                ...
                <div class="form-group">
                    ...
                    <input name="hcp-date" type="date" class="form-control" id="hcp-date" placeholder="Example: Date">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input name="hcp-city" type="text" class="form-control" id="hcp-city" placeholder="Example: Pometo">
                </div>
